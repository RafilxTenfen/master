...
pdf(paste(plots_path, "/vitima_trimestre_bar_plot.pdf", sep=""), width = 18, height = 14)
...
pdf(paste(plots_path, "/vitima_trimestre_ecdf.pdf", sep=""), width = 18, height = 14)
...
data_mix_protocol %>%
  ...
  select(attack_protocol, avarage_requests_by_attack, number_of_attacks, number_of_attacks_percentage, sum_requests_per_attack, number_of_requests_percentage)
...
pdf(paste(plots_path, "/plot_geral_requests_sem_titulo_W18H6.pdf", sep=""), width = 18, height = 6)
print(plot_geral_requests)
dev.off()

g = arrangeGrob(plot_geral_attacks, plot_geral_requests, nrow=2)
ggsave(file = paste(plots_path, "/geral_ataques_requisicoes_2plots_W18H14.pdf", sep=""), g, width = 18, height = 14)
ggsave(file = paste(plots_path, "/geral_ataques_requisicoes_2plots_W18H10.pdf", sep=""), g, width = 18, height = 10)
ggsave(file = paste(plots_path, "/geral_ataques_requisicoes_2plots_W18H8.pdf", sep=""), g, width = 18, height = 8)
ggsave(file = paste(plots_path, "/geral_ataques_requisicoes_2plots_W18H6.pdf", sep=""), g, width = 18, height = 6)
...
pdf(paste(plots_path, "/vitimas_periodo_bar_plot_sem_titulo_W18H12.pdf", sep=""), width = 18, height = 12)
print(vitimas_periodo_bar_plot)
dev.off()
...
pdf(paste(plots_path, "/mix_protocol_line_requests_sem_titulo_W18H6.pdf", sep=""), width = 18, height = 6)
print(mix_protocol_line_requests)
dev.off()
...
pdf(paste(plots_path, "/dns_longevidade_rr_meses_W16H10.pdf", sep=""), width = 16, height = 10)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W16H8.pdf", sep=""), width = 16, height = 8)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W18H10.pdf", sep=""), width = 18, height = 10)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W18H8.pdf", sep=""), width = 18, height = 8)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W18H6.pdf", sep=""), width = 18, height = 6)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W20H10.pdf", sep=""), width = 20, height = 10)
print(dns_plot_logevidade_meses)
dev.off()

pdf(paste(plots_path, "/dns_longevidade_rr_meses_W22H10.pdf", sep=""), width = 22, height = 10)
print(dns_plot_logevidade_meses)
dev.off()
...
pdf(paste(plots_path, "/dns_request_qtype_W16H10.pdf", sep=""), width = 16, height = 10)
print(dns_plot_request_qtype)
dev.off()

pdf(paste(plots_path, "/dns_request_qtype_W16H8.pdf", sep=""), width = 16, height = 8)
print(dns_plot_request_qtype)
dev.off()

pdf(paste(plots_path, "/dns_request_qtype_W16H6.pdf", sep=""), width = 16, height = 6)
print(dns_plot_request_qtype)
dev.off()

pdf(paste(plots_path, "/dns_request_qtype_W18H10.pdf", sep=""), width = 18, height = 10)
print(dns_plot_request_qtype)
dev.off()

pdf(paste(plots_path, "/dns_request_qtype_W18H8.pdf", sep=""), width = 18, height = 8)
print(dns_plot_request_qtype)
dev.off()

pdf(paste(plots_path, "/dns_request_qtype_W18H6.pdf", sep=""), width = 18, height = 6)
print(dns_plot_request_qtype)
dev.off()
...
pdf(paste(plots_path, "/ntp_monlist_incidence_W16H10.pdf", sep=""), width = 16, height = 10, pointsize=16)
print(ntp_plot_monlist)
dev.off()


pdf(paste(plots_path, "/ntp_monlist_incidence_W16H8.pdf", sep=""), width = 16, height = 8, pointsize=16)
print(ntp_plot_monlist)
dev.off()

pdf(paste(plots_path, "/ntp_monlist_incidence_W18H10.pdf", sep=""), width = 18, height = 10, pointsize=16)
print(ntp_plot_monlist)
dev.off()

pdf(paste(plots_path, "/ntp_monlist_incidence_W18H8.pdf", sep=""), width = 18, height = 8)
print(ntp_plot_monlist)
dev.off()

pdf(paste(plots_path, "/ntp_monlist_incidence_W18H6.pdf", sep=""), width = 18, height = 6, pointsize=16)
print(ntp_plot_monlist)
dev.off()
...
data_memcached_payloads_unfetch <-dbSendQuery(db_memcached, "
  SELECT id, SUBSTR(payload,0,25) AS payload_limit, tempo_inicio, tempo_final, CAST(CAST(year AS text) || CAST(period AS text) as integer) as year_period
    FROM (
      SELECT *,  strftime(\"%Y\", tempo_inicio) as year, ((strftime(\"%m\", tempo_final) - 1) / 3) + 1 AS period
...
pdf(paste(plots_path, "/memcached_comandos_W16H10.pdf", sep=""), width = 16, height = 10, pointsize=16)
print(memcached_comandos)
dev.off()

pdf(paste(plots_path, "/memcached_comandos_W16H8.pdf", sep=""), width = 16, height = 8, pointsize=16)
print(memcached_comandos)
dev.off()

pdf(paste(plots_path, "/memcached_comandos_W18H10.pdf", sep=""), width = 18, height = 10)
print(memcached_comandos)
dev.off()

pdf(paste(plots_path, "/memcached_comandos_W18H8.pdf", sep=""), width = 18, height = 8)
print(memcached_comandos)
dev.off()

pdf(paste(plots_path, "/memcached_comandos_W18H6.pdf", sep=""), width = 18, height = 6)
print(memcached_comandos)
dev.off()
