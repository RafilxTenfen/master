...
data_geral_request_attack = data_grouped_period %>%
  ...
  theme(
    ...
    axis.text.y.right = element_text(color = color_requests, size = 14), 
    axis.title.y.right = element_text(color = color_requests, size = 16),
    axis.line.y.left = element_line(color = color_attacks),
    axis.text.y.left = element_text(color = color_attacks, size = 14), 
    axis.title.y.left = element_text(color = color_attacks, size = 16),
...
pdf(paste(plots_path, "/geral_ataques_requisicoes.pdf", sep=""), width = 16, height = 12)
