...
SELECT count, tempoInicio, tempoFinal, ip
...
"""):
  ...
  protocol_mix.append((protocol_id, "NTP", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "DNS", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "CHARGEN", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "CLDAP", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "COAP", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "MEMCACHED", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "QOTD", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "SSDP", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
...
"""):
  ...
  protocol_mix.append((protocol_id, "STEAM_GAMES", count, tempoInicio, tempoFinal, ipVitima))
  protocol_id += 1
