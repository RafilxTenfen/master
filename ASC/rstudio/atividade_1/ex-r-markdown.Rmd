...
- Para estimar o numero de usuarios para o minuto 101, levando em consideração o maior aumento de usuários ja registrado `r WWWusage.diff.max` e o ultimo valor registrado de `r WWWusage.last` usuários, e também a mínima `r WWWusage.min` e máxima ja registrado `r WWWusage.max`, o range provável será entre `r WWWusage.next.min` e `r WWWusage.next.max`.
